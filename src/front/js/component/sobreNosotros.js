...
const SobreNosotros = () => {
  return (
    <div className="container">
      ...
      <ol>
        <li><strong>Innovación Constante:</strong> En ADDM Developers, nos mantenemos a la vanguardia de las tendencias tecnológicas, siempre explorando nuevas herramientas y metodologías para ofrecer soluciones únicas y eficientes.</li>
